...
if(isset($_POST['login'])){
    ...
    $username_sql = "SELECT $password_column, $emailVerification_column , $registration_no_column FROM admin_registration WHERE $registration_no_column = '$user';";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        foreach($row as $data){
            ...
            if($data[$registration_no_column] == "not verified"){
        ...
        $email_sql = "SELECT $password_column, $emailVerification_column , $registration_no_column  FROM admin_registration WHERE $emailVerification_column = '$user';";
